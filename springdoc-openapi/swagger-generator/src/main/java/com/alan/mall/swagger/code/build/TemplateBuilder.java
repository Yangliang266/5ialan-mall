package com.alan.mall.swagger.code.build;

import com.alan.mall.swagger.code.swagger.*;
import com.alan.mall.swagger.code.util.JavaTypes;
import com.alan.mall.swagger.code.util.ModelInfo;
import com.alan.mall.swagger.code.util.StringUtils;
...
public class TemplateBuilder {
    ...
    public static void builder(){
        try {
            ...
            if(databaseType.equals("MySQL")){
                //获取所有表结构
                ResultSet tableResultSet = metaData.getTables(null, "%", TABLE_NAME, new String[]{"TABLE"});
                //获取数据库名字
    ...
    public static List<SwaggerMethod> searchMethod(String Table,String table) {
        ...
        resp200Search.setSchema("#/definitions/"+RESP_BEAN+"«List«" + Table + "»»");
    ...
    public static List<SwaggerMethod> searchPage(String Table,String table){
        ...
        resp200Page.setSchema("#/definitions/"+RESP_BEAN+"«List«"+Table+"»»");
        ...
        resp200PageSearch.setSchema("#/definitions/"+RESP_BEAN+"«List«"+Table+"»»");
    ...
    public static List<SwaggerMethod> handlerById(String Table,String table,String type,String format){
        ...
        resp200Delete.setSchema("#/definitions/"+RESP_BEAN);
        ...
        resp200Update.setSchema("#/definitions/"+RESP_BEAN);
        ...
        resp200FindById.setSchema("#/definitions/"+RESP_BEAN+"«"+Table+"»");
    ...
    public static List<SwaggerMethod> addAndFindAll(String Table,String table){
        ...
        resp200FindAll.setSchema("#/definitions/"+RESP_BEAN+"«List«"+Table+"»»");
        ...
        resp200Add.setSchema("#/definitions/"+RESP_BEAN);
